...
model = msgPassing(message_passing_num=2, node_input_size=out_ndim+1, edge_input_size=3, 
...
setattr(train_config, 'train_steps', 5)    # 1 train step, extend this in the future to a dynamic source function that changes with time.
