...
class ElectroThermalFunc(): 
    ...
    def init_condition(self, pos):
        ...
        temp = torch.full_like(pos[:, 0:1], 0.310)  # Create a tensor filled with 310s for the temperature
    ...
    def pde(self, graph, values_last, values_this, **argv):
        ...
        sigma = f*(1+g*(temp_this*1000 - e)) # Sigma at t+1
        ...
        print("lap_temp")
        print(lap_temp)
        loss_temp = (0.001*((a*b*dvdt) - q - c*lap_temp -d*(e-temp_this*1000)))
